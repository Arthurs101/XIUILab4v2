...
class LetterListFragment : Fragment() {
    ...
    //crear el recicler cuando se crea la vista
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        recyclerView = binding.recyclerView
        chooseLayout()
    }
    //dado que ya no existe la vista quitar el binding
    ...
    private fun chooseLayout() { //configurar dependiendo si es lineal o no
